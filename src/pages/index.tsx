  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="fixed top-4 right-4">
        <Link href="/admin-login" className="bg-white shadow-md hover:shadow-lg text-gray-700 px-3 py-2 rounded-lg text-sm font-medium transition-all flex items-center space-x-1 border">
          <span>📊</span>
          <span>Admin</span>
        </Link>
      </div>
